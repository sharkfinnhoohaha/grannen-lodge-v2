...
export default function PageClient(props: any) {
  // This hook connects the data to the Tina visual editor
  const { data } = useTina({
    query: props.query,
    ...
    <div className="min-h-screen bg-[#faf9f6] text-[#2c3e2d] font-sans selection:bg-[#2c3e2d] selection:text-white">
      ...
      <header className="relative h-screen flex items-center justify-center overflow-hidden">
        <motion.div style={{ opacity: heroOpacity, scale: heroScale }} className="absolute inset-0">
          ...
          <img 
            src={page.heroImage || "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&q=80&w=2000"} 
